...
public class ProductDto {
	...
	public ProductDto(int stock_no, String mem_id, String stock_name, String stock_detail, int stock_kg,
			String stock_image, String stock_location, int stock_kind, int auc_no, int auc_startPrice, int auc_nowPrice,
			int auc_status, Date auc_regDate, Date auc_endDate, int auc_join) {
		super();
