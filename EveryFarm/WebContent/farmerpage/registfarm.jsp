...
<script type="text/javascript">
   ...
   function formcheck(){
      ...
      if(form.wfarm_title.value=="" || form.wfarm_image_01.value=="" || 
         ...
         form.wfarm_image_04.value=="" || form.wfarm_content01.value==""
         || form.wfarm_content02.value=="" || form.wfarm_content03.value=="" || form.wfarm_content04.value==""){
         ...
         if(form.wfarm_title.value==""){
            ...
            alert("농장 상세 이미지를 첨부해주세요!");
            return false;
         } else if(form.wfarm_content01.value==""){
            alert("농장 상세 정보를 입력해주세요!");
            form.wfarm_content01.focus();
            return false;
         } else if(form.wfarm_content02.value==""){
            alert("농장 상세 정보를 입력해주세요!");
            form.wfarm_content02.focus();
            return false;
         } else if(form.wfarm_content03.value==""){
            alert("농장 상세 정보를 입력해주세요!");
            form.wfarm_content03.focus();
            return false;
         } else if(form.wfarm_content04.value==""){
            alert("농장 상세 정보를 입력해주세요!");
            form.wfarm_content04.focus();
            return false;
         }
...
<body>
   ...
   <section>
      ...
      <form action="../farmer.do" method="post" enctype="multipart/form-data" name="registform">
         ...
         <div class="items"><label>농장 소개</label> <br>
         <textarea name="wfarm_content01"></textarea><br>
         ...
         <div class="items"><label style="margin: 0;">농장 상세 사진</label> <br>
            <p>농장 이미지 3장과 그에 따른 상세설명 3가지를 작성해주세요.</p>
            <div class="filebox">
               ...
               <textarea name="wfarm_content02"></textarea><br>
            </div>
            <div class="filebox">
               ...
               <textarea name="wfarm_content03"></textarea><br>
            </div>
            <div class="filebox">
               ...
               <textarea name="wfarm_content04"></textarea><br>
            </div>
